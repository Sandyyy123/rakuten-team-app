...
st.markdown(
    ...
    "**Sandeep_Jonathan_Thomas_Liora** (16 Jul 2026): **public score 0.8902, rank #15**.")
rk = pd.DataFrame({
    "Rank": [1, 4, 8, 13, 15],
    "Team": ["Gaby & xiaosong & Caeles", "ionch", "forgeros", "vincent__ & meriem_e & tbierlaire",
             "Sandeep_Jonathan_Thomas_Liora"],
    "Public score": [0.9273, 0.9074, 0.9011, 0.8907, 0.8902],
})
st.dataframe(rk, use_container_width=True, hide_index=True)
st.caption("Top of the public leaderboard, with our team highlighted at #15.")
...
st.markdown(
    ...
    '<b>#15</b> on the public leaderboard.</div>', unsafe_allow_html=True)
footer()
