...
st.image(fig("thomas/tm_crop_pair.png"), use_container_width=True, caption="Raw product image vs the model input after cropping / resizing.")
...
st.image(fig("thomas/tm_scratch_ablation.png"), use_container_width=True)
...
st.image(fig("thomas/tm_b0_vs_resnet.png"), use_container_width=True)
...
c1, c2 = st.columns(2)
with c1: st.image(fig("thomas/tm_ablation25.png"), use_container_width=True, caption="Ablation over ~25 combinations.")
with c2: st.image(fig("thomas/tm_img_curves.png"), use_container_width=True, caption="Final image model - val F1 ≈ 0.65.")
...
c3, c4 = st.columns(2)
with c3: st.image(fig("thomas/tm_error_clusters.png"), use_container_width=True, caption="Confusion within the two error clusters.")
with c4: st.image(fig("thomas/tm_gradcam_pair.png"), use_container_width=True, caption="GradCAM explanations.")
